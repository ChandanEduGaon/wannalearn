      ...
      <div class="container">
        ...
        <div class="row mb-5 align-items-center">
          <div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src="<?= base_url()?>/public/images/undraw_youtube_tutorial.svg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="row mb-5 align-items-center">
          <div class="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <img src="<?= base_url()?>/public/images/undraw_teaching.svg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="row mb-5 align-items-center">
          <div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src="<?= base_url()?>/public/images/undraw_teacher.svg" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
